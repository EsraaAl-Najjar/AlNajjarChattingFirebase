...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendOreoNotification(RemoteMessage remoteMessage) {
        ...
        Notification.Builder notifyBuilder= oreoNotification.getOreoNotification( title,body,pendingIntent,defaultSound,icon );

        int i = 0;
        if (j>0){
            i=j;
        }
        oreoNotification.getManager().notify( i, notifyBuilder.build() );
    ...
    private void sendNotification(RemoteMessage remoteMessage) {
        ...
        notifiManager.notify( i, builder.build() );
